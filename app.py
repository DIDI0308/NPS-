...
st.markdown("""
    ...
    /* Etiquetas de filtros en blanco para que se vean sobre el negro */
...
# FILA 1: NPS Composition (Se mantiene arriba a la izquierda)
...
with col_top2:
    ...
    fig_lineas.update_traces(line_color='#FFD700', marker=dict(size=10, color='#FF8C00'))
    fig_lineas.update_layout(yaxis_range=[6, 10])
    st.plotly_chart(fig_lineas, use_container_width=True)
    st.markdown("</div>", unsafe_allow_html=True)

# FILA 2: Volume by Secondary Driver (Ancho completo)
st.markdown("<div class='plot-container'>", unsafe_allow_html=True)
if not df_sec.empty:
...
# FILA 3: Avg Score by Secondary Driver (Ancho completo - ABAJO)
st.markdown("<div class='plot-container'>", unsafe_allow_html=True)
if not df_sec.empty:
