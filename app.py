...
# --- SISTEMA DE PESTAÑAS ---
tab_evo, tab_curr = st.tabs(["📊 MONTHLY EVOLUTION", "📅 CURRENT MONTH"])

# ==========================================
# PESTAÑA: MONTHLY EVOLUTION
# ==========================================
with tab_evo:
    st.markdown("<br><br>", unsafe_allow_html=True)
    st.title("📈 MONTHLY EVOLUTION")
    st.info("Esta sección se encuentra en desarrollo. Aquí trabajaremos próximamente en el contenido histórico.")

# ==========================================
# PESTAÑA: CURRENT MONTH
# ==========================================
with tab_curr:
    # --- HEADER / BANNER ---
    ...
    if not df.empty:
        ...
        st.error("Por favor, asegúrese de que el archivo 'Base bruta dic.xlsx' esté en la misma carpeta que el script.")
