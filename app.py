...
# ==========================================
    ...
    if st.button("⬅ VOLVER AL INICIO", key="back_monthly"):
        st.session_state.page = "home"
        st.rerun()
