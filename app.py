...
st.markdown("""
    ...
    .plot-body { background-color: #FFFFFF; padding: 10px; }
    </style>
...
with col2:
    ...
    fig_lineas.update_layout(
        ...
        plot_bgcolor='#FFFFFF',  # Fondo del área de trazado
        font=dict(color="black"),
        yaxis=dict(gridcolor='#EEEEEE', title=None, tickfont=dict(color="black")),
        xaxis=dict(tickfont=dict(color="black"), title=None),
