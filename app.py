...
st.markdown("""
    <style>
    /* ELIMINAR MÁRGENES DE STREAMLIT PARA FULL SCREEN */
    ...
    .main-bg-full {
        width: 100vw;
        height: 100vh;
        object-fit: fill; /* Cubre toda la pestaña */
        position: absolute;
        top: 0;
        left: 0;
    }
    ...
    .button-overlay-anchor {
        ...
        align-items: center;
        padding-bottom: 12vh; /* Ajuste para que queden sobre los cuadros amarillos */
    }
...
if st.session_state.page == 'landing':
    ...
    if b64_bg:
        ...
        # Overlay de botones usando columnas de Streamlit
        # Espacio superior para bajar los botones a la zona de los cuadros amarillos
        st.markdown('<div style="height: 75vh;"></div>', unsafe_allow_html=True)
        col_l, col_btn1, col_gap, col_btn2, col_r = st.columns([1.5, 2.5, 1, 2.5, 1.5])
