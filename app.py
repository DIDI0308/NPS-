...
st.markdown("""
    ...
    /* ESTILO DE TARJETAS CON TÍTULO AMARILLO */
    .plot-card {
        background-color: #FFFFFF;
        border-radius: 15px;
        overflow: hidden; /* Para que el título respete el redondeado */
...
with col1:
    # Tarjeta con cabecera amarilla y cuerpo blanco
    st.markdown("""
        <div class="plot-card">
            <p class="plot-header">1. Primary Driver Composition</p>
            <div class="plot-body">
    """, unsafe_allow_html=True)
...
with col2:
    ...
    st.markdown("""
        <div class="plot-card">
            <p class="plot-header">2. Average Score Per Primary Driver</p>
            <div class="plot-body">
    """, unsafe_allow_html=True)
